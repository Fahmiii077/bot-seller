...
Selama ${clockString(new Date - user.afkTime)}`)
		...
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6281313939614@g.us","inviteCode": "m","groupName": `Danzz Coding`, "caption": `Danzz Coding`, 'jpegThumbnail': await reSize(thumb, 100, 100)}}}
